        ...
        var e = {
            163: e=>{
                e.exports = function(e) {
                    var t, n = [].forEach, l = [].some, o = document.body, r = !0, i = " ";
                    function s(t, l) {
                        var o, r, c, d = l.appendChild((o = t,
                        ...
                        e.includeTitleTags && c.setAttribute("title", o.textContent),
                            ...
                            c.setAttribute("class", e.linkClass + i + "node-name--" + o.nodeName + i + e.extraLinkClasses),
                            r.appendChild(c),
                            r));
                    ...
                    function a(t) {
                        ...
                        return t && (o += i + e.collapsibleClass,
                            o += i + e.isCollapsedClass),
                    ...
                    function d(t) {
                        return t && -1 !== t.className.indexOf(e.collapsibleClass) && -1 !== t.className.indexOf(e.isCollapsedClass) ? (t.className = t.className.split(i + e.isCollapsedClass).join(""),
                        ...
                        updateToc: function(s) {
                            ...
                            e.positionFixedSelector && function() {
                                ...
                                "auto" === e.fixedSidebarOffset && (e.fixedSidebarOffset = t.offsetTop),
                                    n > e.fixedSidebarOffset ? -1 === l.className.indexOf(e.positionFixedClass) && (l.className += i + e.positionFixedClass) : l.className = l.className.split(i + e.positionFixedClass).join("")
                            }();
                            var u, f = s;
                            if (r && null !== t && f.length > 0) {
                                l.call(f, (function(t, n) {
                                        return c(t) > a + e.headingsOffset + 10 ? (u = f[0 === n ? n : n - 1],
                                            !0) : n === f.length - 1 ? (u = f[f.length - 1],
                                            !0) : void 0
                                    }
                                ));
                                var m = t.querySelector("." + e.activeLinkClass)
                                    , h = t.querySelector("." + e.linkClass + ".node-name--" + u.nodeName + '[href="' + e.basePath + "#" + u.id.replace(/([ #;&,.+*~':"!^$[\]()=>|/\\@])/g, "\\$1") + '"]');
                                if (m === h)
                                    return;
                                var p = t.querySelectorAll("." + e.linkClass);
                                n.call(p, (function(t) {
                                ...
                                h && -1 === h.className.indexOf(e.activeLinkClass) && (h.className += i + e.activeLinkClass);
                                var g = h && h.parentNode;
                                g && -1 === g.className.indexOf(e.activeListItemClass) && (g.className += i + e.activeListItemClass);
                                ...
                                h && h.nextSibling && -1 !== h.nextSibling.className.indexOf(e.isCollapsedClass) && (h.nextSibling.className = h.nextSibling.className.split(i + e.isCollapsedClass).join("")),
                                    d(h && h.parentNode.parentNode)
                            }
                        }
                    }
                }
            ...
            971: (e,t,n)=>{
                var l, o, r;
                o = [],
                void 0 === (r = "function" == typeof (l = function(e) {
                    "use strict";
                    var t, l, o, r = n(547), i = {}, s = {}, a = n(163), c = n(279), d = n(938), u = !!(e && e.document && e.document.querySelector && e.addEventListener);
                    if ("undefined" != typeof window || u) {
                        var f = Object.prototype.hasOwnProperty;
                        return s.destroy = function() {
                            var e = h(i);
                            null !== e && (i.skipRendering || e && (e.innerHTML = ""),
                            ...
                            s.init = function(e) {
                                if (u) {
                                    ...
                                    if (null !== p) {
                                        var C = h(i);
                                        if (null !== C && null !== (o = l.selectHeadings(p, i.headingSelector))) {
                                            var g = l.nestHeadingsArray(o).nest;
                                            i.skipRendering || t.render(C, g),
                ...
                }(void 0 !== n.g ? n.g : window || n.g)) ? l.apply(t, o) : l) || (e.exports = r)
            }
            ,
            279: e=>{
                e.exports = function(e) {
                        ...
                        nestHeadingsArray: function(l) {
                            return t.call(l, (function(t, l) {
                                    ...
                                    return r && function(t, l) {
                                        for (var r = o(t), i = r.headingLevel, s = l, a = n(s), c = i - (a ? a.headingLevel : 0); c > 0 && (!(a = n(s)) || i !== a.headingLevel); )
            ...
            374: (e,t)=>{
                t.initSmoothScrolling = function(e) {
                    ...
                    document.body.addEventListener("click", (function(r) {
                            var i;
                            "a" !== (i = r.target).tagName.toLowerCase() || !(i.hash.length > 0 || "#" === i.href.charAt(i.href.length - 1)) || o(i.href) !== l && o(i.href) + "#" !== l || r.target.className.indexOf("no-smooth-scroll") > -1 || "#" === r.target.href.charAt(r.target.href.length - 2) && "!" === r.target.href.charAt(r.target.href.length - 1) || -1 === r.target.className.indexOf(e.linkClass) || function(e, t) {
                                var n, l, o = window.pageYOffset, r = {
                                    duration: t.duration,
                                    offset: t.offset || 0,
                                    callback: t.callback,
                                ...
                                }, i = document.querySelector('[id="' + decodeURI(e).split("#").join("") + '"]') || document.querySelector('[id="' + e.split("#").join("") + '"]'), s = "string" == typeof e ? r.offset + (e ? i && i.getBoundingClientRect().top || 0 : -(document.documentElement.scrollTop || document.body.scrollTop)) : e, a = "function" == typeof r.duration ? r.duration(s) : r.duration;
                                function c(e) {
                                    l = e - n,
                                        window.scrollTo(0, r.easing(l, o, s, a)),
